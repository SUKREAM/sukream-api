...
public class QBidder extends EntityPathBase<Bidder> {
    ...
    public final DateTimePath<java.time.LocalDateTime> bidAt = createDateTime("bidAt", java.time.LocalDateTime.class);
    ...
    public final EnumPath<BidderStatus> status = createEnum("status", BidderStatus.class);

    //inherited
    public final DateTimePath<java.time.LocalDateTime> updatedAt = _super.updatedAt;

    public final com.sukream.sukream.domains.user.domain.entity.QUsers user;
    ...
    public QBidder(Class<? extends Bidder> type, PathMetadata metadata, PathInits inits) {
        ...
        this.user = inits.isInitialized("user") ? new com.sukream.sukream.domains.user.domain.entity.QUsers(forProperty("user")) : null;
    }
